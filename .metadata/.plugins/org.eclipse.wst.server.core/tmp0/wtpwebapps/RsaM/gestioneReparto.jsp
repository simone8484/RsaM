...
<ul class="dropdown">
  ...
  <form method="POST" action="GestioneStrutturaHandler.do?action=nuovoReparto">
    ...
    <form method="POST" action="GestioneStrutturaHandler.do?action=ubicazioneOspiti">
    <input type="submit" value="Gestisci ubicazione ospiti">
    </form> 
    
     <br>
    
    
    <form method="POST" action="GestioneStrutturaHandler.do?action=personaleReparto">
    <input type="submit" value="Gestisci personale reparto">
    </form> 
